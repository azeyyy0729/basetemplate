...
-- Listage de la structure de la base pour esxlegacy_5828d8
CREATE DATABASE IF NOT EXISTS `esxlegacy_5828d8` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci */;
USE `esxlegacy_5828d8`;

-- Listage de la structure de table esxlegacy_5828d8. addon_account
...
-- Listage des données de la table esxlegacy_5828d8.addon_account : ~8 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. addon_account_data
...
-- Listage des données de la table esxlegacy_5828d8.addon_account_data : ~6 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. addon_inventory
...
-- Listage des données de la table esxlegacy_5828d8.addon_inventory : ~5 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. addon_inventory_items
...
-- Listage des données de la table esxlegacy_5828d8.addon_inventory_items : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_5828d8. banking
...
-- Listage des données de la table esxlegacy_5828d8.banking : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_5828d8. billing
...
-- Listage des données de la table esxlegacy_5828d8.billing : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_5828d8. datastore
...
-- Listage des données de la table esxlegacy_5828d8.datastore : ~9 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. datastore_data
...
-- Listage des données de la table esxlegacy_5828d8.datastore_data : ~6 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. fine_types
...
-- Listage des données de la table esxlegacy_5828d8.fine_types : ~52 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. items
...
-- Listage des données de la table esxlegacy_5828d8.items : ~33 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. jobs
...
-- Listage des données de la table esxlegacy_5828d8.jobs : ~14 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. job_grades
...
-- Listage des données de la table esxlegacy_5828d8.job_grades : ~36 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. licenses
...
-- Listage des données de la table esxlegacy_5828d8.licenses : ~6 rows (environ)
...
-- Listage de la structure de table esxlegacy_5828d8. multicharacter_slots
...
-- Listage des données de la table esxlegacy_5828d8.multicharacter_slots : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_5828d8. owned_vehicles
...
-- Listage des données de la table esxlegacy_5828d8.owned_vehicles : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_5828d8. rented_vehicles
...
-- Listage des données de la table esxlegacy_5828d8.rented_vehicles : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_5828d8. society_moneywash
...
-- Listage des données de la table esxlegacy_5828d8.society_moneywash : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_5828d8. users
...
-- Listage des données de la table esxlegacy_5828d8.users : ~0 rows (environ)
...
-- Listage des données de la table esxlegacy_5828d8.user_licenses : ~0 rows (environ)

-- Listage de la structure de table esxlegacy_5828d8. whitelist
CREATE TABLE IF NOT EXISTS `whitelist` (
  `identifier` varchar(60) NOT NULL,
  PRIMARY KEY (`identifier`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_uca1400_ai_ci;

-- Listage des données de la table esxlegacy_5828d8.whitelist : ~0 rows (environ)
