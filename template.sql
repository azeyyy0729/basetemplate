...
-- Listage des données de la table esxlegacy_5828d8.addon_account_data : ~8 rows (environ)
...
-- Listage des données de la table esxlegacy_5828d8.datastore_data : ~11 rows (environ)
...
-- Listage des données de la table esxlegacy_5828d8.licenses : ~7 rows (environ)
...
-- Listage des données de la table esxlegacy_5828d8.users : ~1 rows (environ)
