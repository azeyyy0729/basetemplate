...
RegisterNetEvent("zUI:DisplayPulsingNotification")
AddEventHandler("zUI:DisplayPulsingNotification", function(key, description, coords, styles)
    zUI.DisplayPulsingNotification(key, description, coords, styles)
end)
