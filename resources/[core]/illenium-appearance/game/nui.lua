...
RegisterNUICallback("appearance_save", function(appearance, cb)
    cb(1)
    client.wearClothes(appearance, "hat")
    client.wearClothes(appearance, "earrings")
    client.wearClothes(appearance, "glasses")
    client.wearClothes(appearance, "mask")
    client.wearClothes(appearance, "vest")
    client.wearClothes(appearance, "necklace")
    client.wearClothes(appearance, "shirt")
